        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-20 md:pb-0">
            ...
            <main className="mx-auto max-w-2xl px-4 py-8 sm:px-6 lg:px-8">
                ...
                <div className="mb-8 text-center">
                    <div className="h-9 w-32 mx-auto rounded bg-gray-200 dark:bg-gray-700 animate-pulse mb-2" />
                    <div className="h-5 w-56 mx-auto rounded bg-gray-200 dark:bg-gray-700 animate-pulse" />
                </div>
                ...
                {/* Results skeleton */}
                <SearchResultsSkeleton type="people" />
            </main>
        </div>
    );
}
