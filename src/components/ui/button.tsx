    ...
    'inline-flex items-center justify-center rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
    {
        variants: {
            variant: {
                ...
                outline:
                    'border-2 border-primary-600 bg-transparent text-primary-600 hover:bg-primary-50 dark:hover:bg-primary-950 active:scale-95',
                secondary:
                    'bg-secondary-600 text-white hover:bg-secondary-700 active:scale-95 shadow-md hover:shadow-lg',
